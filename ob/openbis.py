...
def GenericLammpsJobObject(o, space, project, collection, concept_dict):
...
def MurnaghanJobObject(o, space, project, collection, concept_dict, children_concept_dict):
    # o = openbis_login(url, user)
    ...
    if exists:
        ...
        for item in children_concept_dict:
            child_object = GenericLammpsJobObject(o, space, project, collection, item)
